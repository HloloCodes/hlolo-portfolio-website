    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        ...
        <Card
          ...
          description="Once we agree on a plan, I queue my urban gospel playlist and dive into coding."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
// Card Component with Explicit Props Type
const Card = ({
  title,
  icon,
  children,
...
// AceternityIcon Component with Explicit Props Type
...
// Icon Component with Explicit Props Type
